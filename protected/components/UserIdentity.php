...
class UserIdentity extends CUserIdentity {
    ...
    public function authenticate(){
        ...
        if($user->activation==0) die('Выйдете в скайп и ждите активации. Если при попытке активации вы были в оффлайне, то зарегистрируйтесь снова.');
        if(($user===null) || (md5('hs2,1.2m@11!!!.'.$this->password)!==$user->password)) {
